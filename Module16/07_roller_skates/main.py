quantity_roller_skates = int(input("Кол-во коньков: "))
lst_sizes_roller_skates = []
for index in range(1, quantity_roller_skates + 1):
    print(f"Размер {index}-й пары: ", end='')
    lst_sizes_roller_skates.append(int(input()))
print("")
...
count_humans = 0
for size in lst_sizes_roller_skates:
